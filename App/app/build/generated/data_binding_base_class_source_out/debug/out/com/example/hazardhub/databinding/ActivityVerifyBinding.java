...
public final class ActivityVerifyBinding implements ViewBinding {
  ...
  @NonNull
  public final FrameLayout verifyFrame;

  private ActivityVerifyBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main,
      @NonNull FrameLayout verifyFrame) {
  ...
  public static ActivityVerifyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.verifyFrame;
      FrameLayout verifyFrame = ViewBindings.findChildViewById(rootView, id);
      if (verifyFrame == null) {
        break missingId;
      }

      return new ActivityVerifyBinding((ConstraintLayout) rootView, main, verifyFrame);
    }
